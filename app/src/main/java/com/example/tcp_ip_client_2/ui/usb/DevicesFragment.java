...
public class DevicesFragment extends ListFragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.refresh) {
            ...
            builder.setSingleChoiceItems(values, pos, (dialog, which) -> {baudRate = Integer.parseInt(values[which]);dialog.dismiss();});
            builder.create().show();
            return true;
            ...
            builder.setSingleChoiceItems(values, pos, (dialog, which) -> {withIoManager = (which == 0);dialog.dismiss();});
            builder.create().show();
            return true;
        } else {
    ...
    public void onListItemClick(@NonNull ListView l, @NonNull View v, int position, long id) {
        ...
        if(item.driver == null) {
            ...
            navController.navigate(R.id.nav_usb,  args);
        }
    }
